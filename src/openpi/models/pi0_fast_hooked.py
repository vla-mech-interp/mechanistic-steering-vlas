...
import openpi.models.gemma_fast_hooked as _gemma
...
class Pi0FAST(_model.BaseModel):
    ...
    def sample_actions(
        ...
        *,
        ...
        hyperactivate_coeff: float = 10.0,
        ...
        prefix_logits, kv_cache, _ = self.PaliGemma.llm(
            embedded_prefix=prefix_token_embeddings, mask=prefix_attn_mask, positions=prefix_positions,
            decode=True, hyperactivate_mask=hyperactivate_mask, hyperactivate_coeff=hyperactivate_coeff
        )
